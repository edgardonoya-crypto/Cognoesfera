...
export default function QuanamIa2026() {
  ...
  const lentesAbiertasRef = useRef<Set<string>>(new Set())
      ...
      {bienvenida && (
        <div style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24, padding: '0 24px', maxWidth: 480, width: '100%', textAlign: 'center' }}>
            ...
            <p style={{ fontStyle: 'italic', color: '#f0e8d8', background: 'rgba(0,0,0,0.4)', padding: '8px 18px', borderRadius: '4px', display: 'inline-block' }}>{contenido?.zona_convoca}</p>
