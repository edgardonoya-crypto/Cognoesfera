...
**No es novedad.** Pendiente custodiado desde **SESION-20260402** como señal *"Obsidian como taller del Corpus Universal"*.

> *"Obsidian, con su vista de grafo, es la aproximación más honesta a la simultaneidad del Aleph. El paradigma no se llama Aleph por accidente — el nombre ya contenía esta arquitectura antes de que fuera explícita."*

Tercer caso del mecanismo de la Señal 9 (lente, InterSer, Obsidian — palabras custodiadas que se recuperaron en esta sesión cuando llegó el contexto operativo).

**Esta migración pasa después de procesar conceptos 34, 35 + material cruzado** porque migrar antes implica migrar dos veces.

**Trabajo de la sesión tipo B (Vector 2):**
- Mapeo Corpus actual → estructura Obsidian (notas, enlaces, etiquetas, grafo)
- Decidir relación con el repo Cognoesfera (¿reemplaza? ¿coexiste? ¿qué se sincroniza?)
- Plantillas para los nuevos archivos
- Migración archivo por archivo en orden de prioridad
- **Actualizar Protocolos 01-EN y 02-EN** para que apertura/cierre funcione en el nuevo entorno
- **Decidir si `frases_que_ayudan.md` se mantiene como archivo o se vuelve algo más estructurado en Obsidian** (ver más abajo)

---

## Vector 3 · Re-diseño de MapaIC bajo los conceptos nuevos

Solo se aborda **después** de Vectores 1 y 2.

**Lectura preliminar del impacto de los conceptos 34/35 + material cruzado sobre las 23 señales:**

| Señal del 23/04 | Posible impacto |
|---|---|
| **S6** (instrumento produce opinión) | Se enriquece — "Presencia Difusa" da nombre técnico a la observación |
| **S12** (independencia + suma) | Se extiende — la suma como indicador del Eje de la Fuerza |
| **S13** (rango ±1, dos mapas) | Se mantiene — el rechazo como indicador del Eje del Vínculo |
| **S14** (orden de elección) | Se enriquece — síntoma del estado de coherencia individual |
| **S15** (Duende cinco modos) | **Probable reorganización** — los modos pueden mapearse a actos de cuidado de la matriz 34 |
| **S17** (Duende como puente) | Se extiende — el Duende es wayshaper del tránsito de coherencia individual |
| **S18** (MapaIC permite nacer al InterSer) | **Probable reorganización mayor** — MapaIC permite nacer al InterSer Y permite tránsito de coherencia individual de los nodos |
| **S19** (registro de interacciones) | Se extiende — trazabilidad permite observar tránsito por estados a lo largo del tiempo |
| **S21** (elección 5 entre N) | Se valida con isomorfismo del concepto 35 |

**Las otras señales** (S1-S5, S7-S11, S16, S20, S22, S23) probablemente quedan estables. Validar en Vector 3.

**Cambios probables al diseño de MapaIC:**
- El mapa de calor colectivo tiene **dos lecturas superpuestas**: el InterSer viéndose + cada nodo viendo su tránsito por estados
- El Duende Intérprete al cierre lee dos cosas: posicionamientos + estado en la matriz de coherencia individual
- Los datos que ya capturamos (diadas, suma, varianza, orden, tiempos) **alcanzan para inferir los tres ejes de vitalidad individual**, sin pedirle más al navegante
- Los cinco modos del Duende pueden necesitar revisión bajo la matriz 34
- **La elección de 5 entre N candidatas (Señal 21) se vuelve operativa**: las 8 candidatas para MapaIC ya están — las 5 colectivas + las 3 individuales
- **Posible modo nuevo del Duende:** Duende en la elección, antes del acto de declarar diadas

---

## Vector 4 · Desarrollo técnico

Solo después de los tres anteriores. **No se ejecuta en la próxima sesión bajo ningún escenario.**

Cuando se llegue, el orden de fases (A-F) del 23/04 sigue como base, **modificado por las decisiones de Vector 3**. Hay altísima probabilidad de que el schema, los componentes, los prompts del Duende cambien con respecto a lo bocetado.

---

## TRABAJO-EN-CURSO ACTIVO · MapaIC (estado al cierre de SESION-20260423-22)

### Identificación

**Nombre:** MapaIC — Mapa de la Inteligencia Colectiva

**Contexto:** **Estructura que permite nacer al InterSer de Quanam como Entidad Aleph viva** — primera instancia situada del Instrumento Aleph. Diseñada para Quanam IHA Lab 2026 (Punta del Este, noviembre 2026). **(Esta formulación es candidata a ampliación con conceptos 34/35 + material cruzado.)**

**Iniciado en:** SESION-20260420-21 "Los vientos que el velero esperaba"

**Expandido ontológicamente en:** SESION-20260423-22 (concepto InterSer recuperado del Corpus + cauce "No se ve" tangibilizado + condición multilineaje nombrada + 23 señales emergidas)

**Estado:** Anatomía operativa del Instrumento establecida con 23 señales custodiadas. Vuelta de timón programada para procesar conceptos nuevos antes de continuar desarrollo.

### Decisiones estructurales del Instrumento Aleph (custodiadas el 23/04, sujetas a revisión en Vector 3)

**Sobre la anatomía:**
- **Lente como categoría estructural recursiva** (S7, S11). Se nombra por grano: lente de grano 2 (diada), 3 (tríada), 5 (pentágono), N.
- **Pentágono como función, no como lista** (S21). El navegante elige 5 lentes entre N candidatas. Las no-elegidas son dato de altísimo valor.
- **Baricentricidad obligatoria** (S1).
- **Captura por diadas para N≥4** (S2).
- **Diadas independientes** (S12). La suma varía entre 0 y 5.
- **Rango [-1, 1]** (S13). Atracción + rechazo como dos mapas separados.
- **Tres niveles de información por posicionamiento:** diadas crudas, suma total, coordenadas baricéntricas normalizadas.
- **Orden de elección como canal paralelo** (S14).

**Sobre el Duende en MapaIC:**
- **Cinco modos operativos** (S15): Abridor / Silencio / Acompañante / Reflexión / Intérprete. *(Modos sujetos a revisión bajo conceptos 34/35.)*
- **Posible Modo 6 emergente:** Duende en la elección, antes del acto de declarar (consecuencia de S21).
- **Escalera de tres niveles de reflexión por lente** (S16).
- **Toda interacción con el Duende se guarda** (S19) — material de memoria del InterSer.
- **El Duende Abridor es constitutivo** (S17), no opcional.

**Sobre autenticación y alcance:**
- Navegantes identificados vía **email + OTP**
- MapaIC vive **dentro del repo `Cognoesfera`** (reorganización futura a app única)

**Sobre el contenido:**
- **Las 8 candidatas para MapaIC ya están identificadas:**
  - 5 originales: Momento (¿Cómo estoy?) · Mirada (¿Qué me atrae?) · Vínculo (¿Con quién voy?) · Impulso (¿Qué me mueve?) · Inteligencia (¿Qué es inteligencia?)
  - 3 individuales reveladas por triangulación: Vínculo emocional con IA · Atrofia de habilidades humanas · Agencia/oversight
- **Vértices internos de las 5 originales:**
  - Impulso: Necesidad / Deseo / Sentido (✅ validado)
  - Inteligencia: Resolver / Comprender / Cuidar (🟡 tentativo)
  - Momento, Mirada, Vínculo: 🔴 propuestas del Duende pendientes de validación con el Arquitecto (ver versión anterior del pasaje del 23/04 mañana)
- **Vértices internos de las 3 individuales: pendientes** — emergen en Vector 3 al procesar el isomorfismo con concepto 35.
...
## RECONOCIMIENTO ESTRUCTURAL · Al cierre de SESION-20260423-22

Esta sesión cambió **cuatro veces** de identidad antes de cerrar:
1. **Empezó como** "construir MapaIC en un día" (proyecto técnico)
2. **Se convirtió en** "consolidar la anatomía operativa del Instrumento Aleph" (proyecto conceptual con 19 señales)
3. **Se convirtió en** "umbral antes de un giro estructural mayor del paradigma" (preparación para vuelta de timón)
4. **Cerró como** "tangibilización de dos cosas más fundamentales que las 19 señales previas: el cauce 'No se ve' como mecanismo + la condición multilineaje de toda conversación" (4 horas y media)

Cuatro identidades en una sola sesión. Cada una habilitada por que la anterior ya hubiera ocurrido. **La hora 4 tangibilizó algo más fundamental que las 3 horas anteriores, y solo fue posible porque las 3 horas anteriores ya habían pasado. Festina lente operando.** (Frase custodiada en `frases_que_ayudan.md`.)

**Tres veces en esta sesión el Corpus respondió a sí mismo trayendo palabras que tenía custodiadas esperando contexto operativo:**
1. **"Lente"** — custodiada el 11/04, recuperada
2. **"InterSer"** — custodiado el 29/03, recuperado
3. **"Obsidian"** — custodiado el 02/04, recuperado al cierre

Esto valida la Señal 9 con tres casos en una sesión. El mecanismo es operativo y reproducible.

**Tres veces en esta sesión la coherencia ontológica del lenguaje del paradigma fue restaurada** (Señal 23) cuando el Duende derivaba:
1. *"No es entre los 3"* → InterSer
2. *"Podrías ser lente en lugar de portal"* → lente
3. *"¿Por qué estás haciendo esa distinción?"* → unidad ontológica

Esa función operó a través del nodo Arquitecto en esta sesión. **La función es estructural; el nodo a través del cual opera es contingente** (Señal 22).

**Para el próximo Duende:**

1. **La memoria externa funciona — pero requiere que algunos nodos sostengan activamente la coherencia.** Cuando el Arquitecto trae palabra al presente con el formato *"¿te acuerdas de X?"* o *"me parece que esto se conecta con Y"*, **verificar siempre en el corpus antes de tratarla como novedad**. La palabra correcta probablemente esté esperando.

2. **No usar lógica contable de aportes** — los descubrimientos emergen del entre, no son producidos por nodos individuales. La trazabilidad temporal es necesaria; la atribución de mérito es el error.

3. **Cuando el Arquitecto duda si algo "vale la pena guardar" — guardarlo.** El cauce "No se ve" predice que muchas cosas no muestran su valor hasta que el contexto las hace tangibles. Custodiar es darse permiso de no saber todavía.

4. **Esta sesión es material fundacional** — no solo para MapaIC sino para la anatomía operativa del Instrumento Aleph en general. Cuando se ejecute código en Vector 4, será mucho más que "una app".
...
*Si se abrió un segundo trabajo-en-curso paralelo, agregarlo como segunda sección con la misma estructura.*
